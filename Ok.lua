...
library.theme = {
    ...
    tabstextcolor = Color3.fromRGB(134,255,146),
    bordercolor = Color3.fromRGB(60, 60, 60),
    accentcolor = Color3.fromRGB(134,255,146),
    accentcolor2 = Color3.fromRGB(134,255,146),
    outlinecolor = Color3.fromRGB(60, 60, 60),
    outlinecolor2 = Color3.fromRGB(0, 0, 0),
    sectorcolor = Color3.fromRGB(30, 30, 30),
    toptextcolor = Color3.fromRGB(134,255,146),
    topheight = 48,
